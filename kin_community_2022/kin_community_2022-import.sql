...
CREATE DATABASE `kin_community_2022`;

USE `kin_community_2022`;
...
LOAD DATA LOCAL INFILE 'kin_community_2022-words.txt' INTO TABLE words;
LOAD DATA LOCAL INFILE 'kin_community_2022-sentences.txt' INTO TABLE sentences;
LOAD DATA LOCAL INFILE 'kin_community_2022-co_s.txt' INTO TABLE co_s;
LOAD DATA LOCAL INFILE 'kin_community_2022-co_n.txt' INTO TABLE co_n;
LOAD DATA LOCAL INFILE 'kin_community_2022-inv_w.txt' INTO TABLE inv_w;
LOAD DATA LOCAL INFILE 'kin_community_2022-inv_so.txt' INTO TABLE inv_so;
LOAD DATA LOCAL INFILE 'kin_community_2022-sources.txt' INTO TABLE sources;
